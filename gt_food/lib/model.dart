...
class Day {
    ...
    factory Day.fromJson(Map<String, dynamic> json) => Day(
        ...
        menuInfo: MenuInfo.fromJson(json["menu_info"]),
...
class MenuInfo {
    ...
    MenuInfo({
        required this.the186742,
    });

    factory MenuInfo.fromJson(Map<String, dynamic> json) => MenuInfo(
        the186742: The186742.fromJson(json["186742"]),
    );

    Map<String, dynamic> toJson() => {
        "186742": the186742.toJson(),
    };
}
...
class The186742 {
    ...
    factory The186742.fromJson(Map<String, dynamic> json) => The186742(
        position: json["position"],
        sectionOptions: SectionOptions.fromJson(json["section_options"]),
    );

    Map<String, dynamic> toJson() => {
        "position": position,
        "section_options": sectionOptions.toJson(),
    };
}
...
class SectionOptions {
    ...
    factory SectionOptions.fromJson(Map<String, dynamic> json) => SectionOptions(
        ...
        sectionTitleCanExpandCollapse: json["section_title_can_expand_collapse"],
    );
...
class Food {
    ...
    factory Food.fromJson(Map<String, dynamic> json) => Food(
        ...
        roundedNutritionInfo: Map.from(json["rounded_nutrition_info"]).map((k, v) => MapEntry<String, double?>(k, v?.toDouble())),
    ...
    Map<String, dynamic> toJson() => {
        ...
        "rounded_nutrition_info": Map.from(roundedNutritionInfo).map((k, v) => MapEntry<String, dynamic>(k, v)),
...
final descriptionValues = EnumValues({
    "Burrito or Bowl or Twisted Nachos.": Description.BURRITO_OR_BOWL_OR_TWISTED_NACHOS,
    "": Description.EMPTY
});
...
class Icons {
    ...
    factory Icons.fromJson(Map<String, dynamic> json) => Icons(
        foodIcons: List<Icon>.from(json["food_icons"].map((x) => Icon.fromJson(x))),
        myplateIcons: List<Icon>.from(json["myplate_icons"].map((x) => Icon.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "food_icons": List<dynamic>.from(foodIcons.map((x) => x.toJson())),
        "myplate_icons": List<dynamic>.from(myplateIcons.map((x) => x.toJson())),
    };
}
...
enum HelpText { THIS_CONTAINS_WHEAT, THIS_CONTAINS_CHICKEN, ITEM_CONTAINS_GLUTEN, THIS_IS_HALAL, THIS_IS_FREE_OF_ANY_ANIMAL_PRODUCTS_AND_SUITABLE_FOR_VEGANS, THIS_IS_GLUTEN_FREE, THIS_CONTAINS_MILK, THIS_CONTAINS_EGG, THIS_CONTAINS_SOY, THIS_IS_MEAT_FREE_AND_SUITABLE_FOR_VEGETARIANS, THIS_CONTAINS_BEEF, THIS_CONTAINS_SESAME, THIS_CONTAINS_TREE_NUTS, THIS_CONTAINS_PORK, THIS_CONTAINS_TURKEY, THIS_CONTAINS_FISH, THIS_CONTAINS_SHELLFISH, THIS_CONTAINS_GRAIN, THIS_CONTAINS_PROTEIN, THIS_CONTAINS_VEGETABLES, THIS_CONTAINS_DAIRY, THIS_CONTAINS_FRUIT, HAS_CEREALS_CONTAINING_GLUTEN }
...
final helpTextValues = EnumValues({
    ...
    "This is free of any animal products and suitable for vegans": HelpText.THIS_IS_FREE_OF_ANY_ANIMAL_PRODUCTS_AND_SUITABLE_FOR_VEGANS,
    "This is gluten-free!": HelpText.THIS_IS_GLUTEN_FREE,
    "This is halal": HelpText.THIS_IS_HALAL,
    "This is meat-free and suitable for vegetarians": HelpText.THIS_IS_MEAT_FREE_AND_SUITABLE_FOR_VEGETARIANS
});

enum IconSlugEnum { DEFAULT_WHEAT, DEFAULT_CHICKEN, DEFAULT_CEREALS_CONTAINING_GLUTEN, DEFAULT_HALAL, DEFAULT_VEGAN, DEFAULT_GLUTEN_FREE, DEFAULT_MILK, DEFAULT_EGG, DEFAULT_SOY, DEFAULT_VEGETARIAN, DEFAULT_BEEF, DEFAULT_SESAME, DEFAULT_TREE_NUTS, DEFAULT_PORK, DEFAULT_TURKEY, DEFAULT_FISH, DEFAULT_SHELLFISH, MYPLATE_GRAIN, MYPLATE_PROTEIN, MYPLATE_VEGETABLE, MYPLATE_DAIRY, MYPLATE_FRUIT }

final iconSlugEnumValues = EnumValues({
    "default.beef": IconSlugEnum.DEFAULT_BEEF,
    "default.cereals-containing-gluten": IconSlugEnum.DEFAULT_CEREALS_CONTAINING_GLUTEN,
...
enum Name { WHEAT, CHICKEN, GLUTEN, HALAL, VEGAN, GLUTEN_FREE, MILK, EGG, SOY, VEGETARIAN, BEEF, SESAME, TREE_NUTS, PORK, TURKEY, FISH, SHELLFISH, GRAIN, PROTEIN, VEGETABLE, DAIRY, FRUIT, CONTAINING_GLUTEN, GLUTEN_FRIENDLY, CEREALS_CONTAINING_GLUTEN }
...
enum PurpleSlug { WHEAT, CHICKEN, CONTAINING_GLUTEN, HALAL, VEGAN, GLUTEN_FRIENDLY, MILK, EGG, SOY, VEGETARIAN, BEEF, SESAME, TREE_NUTS, PORK, TURKEY, FISH, SHELLFISH, GRAIN, PROTEIN, VEGETABLE, DAIRY, FRUIT }
...
enum ClassName { WHEAT_ICON, CHICKEN_ICON, CEREALS_W_GLUTEN_ICON, HALAL_ICON, VEGAN_ICON, GLUTEN_FREE_ICON, MILK_ICON, EGG_ICON, SOY_ICON, VEGETARIAN_ICON, BEEF_ICON, SESAME_ICON, TREE_NUTS_ICON, PORK_ICON, TURKEY_ICON, FISH_ICON, SHELLFISH_ICON, GRAIN_GROUP, PROTEIN_GROUP, VEGETABLE_GROUP, DAIRY_GROUP, FRUIT_GROUP }
...
enum ServingSizeUnit { EACH, SLICE, OZ, THE_3_OZ_SCOOP, THE_4_OZ_LADLE, SERVING, THE_4_OZ_PORTION, CUPS, THE_12_CUP, CUP, THE_2_OZ_PORTION, SLICE_18_PIZZA, PORTION }
...
enum HallLocation { WHITE_GOLD_GRILL, EMPTY, GINGER_SPICE, VEGAN_VEGETARIAN, LEANING_TOWER, MINDFUL_BYTES, TECH_TAQUERIA, FRUIT, RAMBLIN_COFFEE_SWEETS }
